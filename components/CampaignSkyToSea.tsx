  ...
  return (
    <>
      ...
      <main>
        ...
        >
          <style>{`@media (max-width:768px){.gch-spot-content{padding:48px 20px 44px !important;justify-content:flex-start !important;min-width:0 !important}.gch-spot-stats{grid-template-columns:repeat(2,1fr) !important}.gch-spot-img{min-height:300px !important;min-width:0 !important}.gch-contact-grid{grid-template-columns:1fr !important;gap:22px 0 !important}.gch-contact-val{word-break:break-word}.gch-badges img{height:84px !important}.gch-proof{gap:14px !important;flex-wrap:nowrap !important}.gch-proof-item{flex:1 1 0 !important;min-width:0 !important;flex-direction:column !important;align-items:center !important;text-align:center;gap:12px !important}.gch-proof-item>div{display:flex !important;flex-direction:column !important;align-items:center !important}.gch-btn-row{display:grid !important;grid-template-columns:minmax(0,max-content) !important;justify-content:start !important;gap:12px !important;max-width:100% !important}.gch-btn-row--center{justify-content:center !important}.gch-btn-row>.btn{width:auto !important;justify-self:stretch !important;max-width:100% !important}}`}</style>
          <div
