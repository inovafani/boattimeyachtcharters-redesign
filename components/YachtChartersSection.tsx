...
const CHARTERS: CharterCard[] = [
  ...
  },
  {
    ...
    title: 'Wedding',
    em: 'Yacht Charter',
    body: 'Say "I Do" aboard a luxury superyacht. The idyllic floating venue for Gold Coast wedding ceremonies and receptions with up to 150 guests.',
    stat: 'Up to 150 guests',
    col: 'span 5',
    row: 'span 2',
